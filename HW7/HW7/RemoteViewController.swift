...
class RemoteViewController: UIViewController {
    ...
    func getFavoriteChannelChangeAction(segment: UISegmentedControl) -> UIAction {
        ...
        let action = UIAction() { (action) in
            ...
            self.channelSetAction(self.favorites[segment.selectedSegmentIndex])
        }
    ...
    public func setFavoriteChannel(nBtn:Int,name:String,channel:Int){
        self.favorites[nBtn] = channel
        self.segment.setTitle(name, forSegmentAt: nBtn)
    }
